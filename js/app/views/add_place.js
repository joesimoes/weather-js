      ...
      '<form role="form>',
        '<div class="form-group">',
          '<label for="countryCodeInput">Country Code</label>',
            '<input type="text" class="form-control" id="countryCodeInput" placeholder="Enter a country"></input>',
        '</div>',
        '<div class="form-group">',
          '<label for="nameInput">Place Name</label>',
            '<input type="text" class="form-control" id="nameInput placeholder="Enter the place"></input>',
        '</div>',
